...
<head>
    ...
    <title>Webteck - Technology & IT Solutions HTML Template - Pricing Plans</title>
    ...
    <div class="breadcumb-wrapper " data-bg-src="assets/img/bg/breadcumb-bg.jpg">
        <div class="container">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Pricing Plans</h1>
    ...
    <section class="space">
        <div class="container">
            <div class="title-area text-center">
                ...
                <h2 class="sec-title">Popular Pricing <span class="text-theme fw-normal">Package</span></h2>
            </div>
                        ...
                        <div class="price-card_content">
                            <div class="checklist">
                                <ul>
                                    ...
                                    <li class="unavailable"><i class="fas fa-circle-check"></i> Data backup and recovery</li>
                                    <li class="unavailable"><i class="fas fa-circle-check"></i> Synced To Cloud Database</li>
                                </ul>
                            </div>
                            <a href="pricing.html" class="th-btn">PURCHASE NOW<i class="fa-regular fa-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
