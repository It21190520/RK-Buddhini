...
<head>
    ...
    <title>Webteck - Technology & IT Solutions HTML Template - Team Details</title>
            ...
            <div class="row mt-5 pt-10">
                <div class="col-xl-6 mb-xl-0">
                    ...
                    <div class="skill-feature style2">
                        <h5 class="skill-feature_title">Team Experience</h5>
                        <div class="progress">
                    ...
                    <div class="skill-feature style2">
                        <h5 class="skill-feature_title">Project Success</h5>
                        <div class="progress">
                    ...
                    <div class="skill-feature style2">
                        <h5 class="skill-feature_title">Positive Review</h5>
                        <div class="progress">
